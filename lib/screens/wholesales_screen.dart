            ...
            child: MasonryGridView.count(
              ...
              itemBuilder: (context, index) {
                ...
                return WholeSalesProductCard(
                  ...
                  name: product.name,
                  main_price: product.base_price.toString(),
                  stroked_price: product.base_discounted_price.toString(),
...
class WholeSalesProductCard extends StatefulWidget {
  ...
  WholeSalesProductCard({
    ...
    this.discount,
  })  : is_wholesale = is_wholesale, // Assigning is_wholesale to is_wholesale
        super(key: key);
...
class _WholeSalesProductCardState extends State<WholeSalesProductCard> {
  ...
  Widget build(BuildContext context) {
    debugPrint(
        'Wholesale status: ${widget.is_wholesale}'); // Debug print to check wholesale status
    return InkWell(
      onTap: () {
        Navigator.push(
          context,
              ...
              children: <Widget>[
                AspectRatio(
                  ...
                  child: Stack(children: [
                    ...
                    if (whole_sale_addon_installed.$ && widget.is_wholesale!)
                      Positioned(
                        bottom: 0,
                        child: Container(
                          padding:
