...
class MyTheme {
  ...
  static const Color text_field_grey = Color.fromRGBO(209, 209, 209, 1);
  ...
  static TextTheme textTheme1 = TextTheme(
    bodyLarge: TextStyle(fontFamily: "BeVietnamPro", fontSize: 14),
    bodyMedium: TextStyle(fontFamily: "BeVietnamPro", fontSize: 12),
  );
