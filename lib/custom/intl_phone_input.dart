...
class _InputWidgetState extends State<CustomInternationalPhoneNumberInput> {
  ...
  void initialiseWidget() async {
    if (widget.initialValue != null &&
        widget.initialValue!.phoneNumber != null &&
  ...
  void loadCountries({Country? previouslySelectedCountry}) {
    ...
    Country selectedCountry = previouslySelectedCountry ??
    ...
    return selectorConfig.selectorType == PhoneInputSelectorType.DROPDOWN
        ...
        : Container(
            ...
            decoration: BoxDecoration(
                color: Colors.white,
                border: Border.all(color: MyTheme.text_field_grey, width: .5),
            ...
            child: TextButton(
              ...
              child: Padding(
                ...
                child: Item(
                    ...
                    useEmoji: selectorConfig.useEmoji,
                    textStyle: TextStyle(
                        color: MyTheme.text_field_grey) //selectorTextStyle,
                    ),
              ),
            ),
          );
