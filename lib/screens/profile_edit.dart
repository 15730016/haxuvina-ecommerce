...
class _ProfileEditState extends State<ProfileEdit> {
  ...
  onPressUpdatePassword() async {
    ...
    if (profileUpdateResponse.result == false) {
      print("❌ API message (fail): ${profileUpdateResponse.message}");

      ToastComponent.showDialog(
        profileUpdateResponse.message,
      );
    } else {
      print("✅ API message (success): ${profileUpdateResponse.message}");
        ...
        Padding(
          ...
          child: Container(
            ...
            child: TextField(
              ...
              decoration:
                  InputDecorations.buildInputDecoration_1(hint_text: "Họ và Tên")
                      .copyWith(
                enabledBorder: OutlineInputBorder(
                  borderSide: BorderSide.none,
                ),
