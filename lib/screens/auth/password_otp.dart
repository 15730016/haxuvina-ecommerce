...
class _PasswordOtpState extends State<PasswordOtp> {
  ...
  onTapResend() async {
    final response = await AuthRepository().getPasswordResendCodeResponse(
      widget.email_or_code,
      widget.verify_by,
    );

    ToastComponent.showDialog(response.message ?? "Không thể gửi lại mã");
  }
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                          border: Border.all(
                              color: MyTheme.text_field_grey, width: 1),
                          borderRadius:
